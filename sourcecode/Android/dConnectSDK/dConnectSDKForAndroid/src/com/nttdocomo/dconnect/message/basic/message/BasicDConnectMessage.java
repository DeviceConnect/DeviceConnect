...
import com.nttdocomo.dconnect.message.basic.factory.DConnectMessageParser;
import com.nttdocomo.dconnect.message.factory.MessageHandler;
import com.nttdocomo.dconnect.message.factory.MessageParser;
...
public class BasicDConnectMessage extends HashMap<String, Object> implements DConnectMessage {
     ...
     * ロガーインスタンス.
     */
    private static Logger mLogger = Logger.getLogger("dconnect.sdk.java");
