 ...
 *              ComponentName.unflattenFromString("com.nttdocomo.android.dconnect/.DConnectBroadcastReceiver"), 
 *              getPackageName(), 
 *              "Auth Example App", 
...
public final class IntentAuthProcessor {
     ...
     * {@link com.nttdocomo.dconnect.message.intent.impl.io.IntentResponseReceiver}
     * の登録が必要となる。
     * 
     ...
     * @param callback 処理結果の通知を受けるハンドラ
     */
    public static void authorize(final Context context, final ComponentName dConnectComponent,
            final String packageName, final String appName, final String[] scopes,
            final AuthorizationHandler callback) {
        ...
        } else if (dConnectComponent == null) {
            throw new IllegalArgumentException("dConnectComponent is null.");
        ...
        request.setHeader(HttpHeaders.HOST, dConnectComponent.flattenToShortString());

        ErrorCode error = null;
        HttpParams params = new BasicHttpParams();
        IntentConnectionParams.setContext(params, context);
        IntentConnectionParams.setComponent(params, dConnectComponent);
