 ...
 */
package com.nttdocomo.dconnect.message.intent.impl.factory;
...
import com.nttdocomo.dconnect.message.basic.message.DConnectEventMessage;
...
public class IntentMessageFactory implements MessageFactory<Intent> {
    ...
    public static IntentMessageFactory getMessageFactory() {
        Logger.getLogger("dconnect.sdk.android").entering(
        ...
        Logger.getLogger("dconnect.sdk.android").exiting(
