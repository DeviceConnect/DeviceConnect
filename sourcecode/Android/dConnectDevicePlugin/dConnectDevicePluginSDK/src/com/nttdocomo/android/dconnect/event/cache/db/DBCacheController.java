...
import com.nttdocomo.android.dconnect.event.cache.BaseCacheController;
import com.nttdocomo.android.dconnect.event.cache.db.ClientDao.Client;
import com.nttdocomo.android.dconnect.event.cache.db.EventSessionDao.EventSession;
...
public final class DBCacheController extends BaseCacheController {
    ...
    private class EventDBOpenHelper extends SQLiteOpenHelper {
         ...
         * DBファイル名.
         */
        private static final String DB_NAME = "__dconnect_event.db";
