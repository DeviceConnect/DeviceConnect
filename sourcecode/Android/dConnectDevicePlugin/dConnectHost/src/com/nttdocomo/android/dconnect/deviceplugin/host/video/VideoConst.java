...
public class VideoConst {
    ...
    /** Video起動のAction名. */
	public static final String SEND_HOSTDP_TO_VIDEO = "com.nttdocomo.android.dconnect.SEND_HOSTDP_TO_VIDEO";
	
    /** Video起動のAction名. */
    public static final String SEND_VIDEO_TO_HOSTDP = "com.nttdocomo.android.dconnect.SEND_VIDEO_TO_HOSTDP";
    ...
    /** Video起動のAction名. */
    public static final String SEND_HOSTDP_TO_VIDEOPLAYER = "com.nttdocomo.android.dconnect.SEND_HOSTDP_TO_VIDEOPLAYER";
    
    /** Video起動のAction名. */
    public static final String SEND_VIDEOPLAYER_TO_HOSTDP = "com.nttdocomo.android.dconnect.SEND_VIDEOPLAYER_TO_HOSTDP";
