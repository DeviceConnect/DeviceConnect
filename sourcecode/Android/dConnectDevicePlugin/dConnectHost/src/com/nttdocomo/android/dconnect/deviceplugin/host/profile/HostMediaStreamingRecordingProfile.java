...
import com.nttdocomo.android.dconnect.deviceplugin.host.audio.AudioConst;
import com.nttdocomo.android.dconnect.deviceplugin.host.audio.AudioRecorder;
import com.nttdocomo.android.dconnect.deviceplugin.host.camera.CameraActivity;
import com.nttdocomo.android.dconnect.deviceplugin.host.camera.CameraConst;
import com.nttdocomo.android.dconnect.deviceplugin.host.video.PhotoActivity;
import com.nttdocomo.android.dconnect.deviceplugin.host.video.PhotoConst;
import com.nttdocomo.android.dconnect.deviceplugin.host.video.VideoConst;
import com.nttdocomo.android.dconnect.deviceplugin.host.video.VideoRecorder;
        ...
        if (deviceId == null) {
            ...
            if (error == EventError.NONE) { 
               ...
               mIntent.setClassName("com.nttdocomo.android.dconnect.deviceplugin.host",
                       "com.nttdocomo.android.dconnect.deviceplugin.host.video.PhotoActivity");
               mIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    protected boolean onPostRecord(final Intent request, final Intent response, final String deviceId,
        ...
        if (deviceId == null) {
            ...
            if (target == null) {
                ...
                Intent mIntent = new Intent();
                mIntent.setClassName("com.nttdocomo.android.dconnect.deviceplugin.host",
                        "com.nttdocomo.android.dconnect.deviceplugin.host.video.VideoRecorder");
                mIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                this.getContext().startActivity(mIntent);
                setResult(response, DConnectMessage.RESULT_OK);
                ...
                Intent mIntent = new Intent();
                mIntent.setClassName("com.nttdocomo.android.dconnect.deviceplugin.host",
                        "com.nttdocomo.android.dconnect.deviceplugin.host.audio.AudioRecorder");
                mIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                this.getContext().startActivity(mIntent);
                setResult(response, DConnectMessage.RESULT_OK);
