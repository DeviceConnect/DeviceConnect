...
public class PhotoConst {
    ...
    /** カメラへのアクション. */
	public static final String SEND_HOSTDP_TO_PHOTO = "com.nttdocomo.android.dconnect.SEND_HOSTDP_TO_PHOTO";
	
	/** カメラからのアクション. */
	public static final String SEND_PHOTO_TO_HOSTDP = "com.nttdocomo.android.dconnect.SEND_PHOTO_TO_HOSTDP";
