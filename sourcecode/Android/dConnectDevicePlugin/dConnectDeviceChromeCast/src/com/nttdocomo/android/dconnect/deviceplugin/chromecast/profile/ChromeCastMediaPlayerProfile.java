...
public class ChromeCastMediaPlayerProfile extends MediaPlayerProfile {
	...
	protected boolean onGetMediaList(Intent request, Intent response,
		...
		setMediaId(medium,
				"https://bennugd-vlc.googlecode.com/files/sintel_trailer-480p.mp4");
		setMIMEType(medium, "MIMEType");
		setTitle(medium, "Title" + list.size());
		setDuration(medium, 9999);
		creatorVideo = new Bundle();
		setCreator(creatorVideo, "Creator" + list.size());
