...
public class WearNotificationProfile extends NotificationProfile {
	...
	protected boolean onPostNotify(final Intent request, final Intent response,
			final String deviceId, final NotificationType type,
			final Direction dir, final String lang, final String body,
		...
		if (deviceId == null) {
			...
			List<Event> events = EventManager.INSTANCE.getEventList(
					deviceId, 
					WearNotificationProfile.PROFILE_NAME,
                    null, 
                    WearNotificationProfile.ATTRIBUTE_ON_SHOW);
			...
			Intent mIntent = new Intent(this.getContext(), 
					com.nttdocomo.android.dconnect.deviceplugin.wear.WearDeviceService.class);
			...
			case UNKNOWN:
				...
				myNotificationBuilder =  
				        new NotificationCompat.Builder(this.getContext())  
				                .setSmallIcon(R.drawable.notification_04)  
				                .setContentTitle("Unkown")  
				                .setContentText(body) 
			...
			case PHONE:
				...
				myNotificationBuilder =  
				        new NotificationCompat.Builder(this.getContext())  
				                .setSmallIcon(R.drawable.notification_00)  
			...
			case MAIL:
				...
				myNotificationBuilder =  
				        new NotificationCompat.Builder(this.getContext())  
				                .setSmallIcon(R.drawable.notification_01)  
			...
			case SMS:
				...
				myNotificationBuilder =  
				        new NotificationCompat.Builder(this.getContext())  
				                .setSmallIcon(R.drawable.notification_02)  
				                .setContentTitle("SMS")  
				                .setContentText(body) 
				                .setContentIntent(pendingIntent) 
				                .setLargeIcon(myBitmap);   
			...
			case EVENT:
				...
				myNotificationBuilder =  
				        new NotificationCompat.Builder(this.getContext())  
				                .setSmallIcon(R.drawable.notification_03)  
		...
		if (deviceId == null) {
			...
			MessageUtils.setInvalidRequestParameterError(response);
			 ...
			 List<Event> events = EventManager.INSTANCE.getEventList(
					 	...
					 	WearNotificationProfile.PROFILE_NAME,
	                    null, 
	                    WearNotificationProfile.ATTRIBUTE_ON_CLOSE);
