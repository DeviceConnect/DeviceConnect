...
import com.nttdocomo.android.dconnect.manager.setting.OpenSourceLicenseFragment.OpenSourceSoftware;
...
public class SettingsFragment extends PreferenceFragment
    ...
    /** 外部IP設定チェックボックス. */
    private CheckBoxPreference checkBoxGlobalPreferences;
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        // グローバル設定のON/OFF
        checkBoxGlobalPreferences = (CheckBoxPreference)
                getPreferenceScreen().findPreference(getString(R.string.key_settings_dconn_allow_global_ip));
        checkBoxGlobalPreferences.setOnPreferenceChangeListener(this);
        ...
        checkBoxGlobalPreferences.setEnabled(!isDConnectServiceRunning());
    }
    ...
    public boolean onPreferenceChange(
        ...
        if (preference instanceof EditTextPreference) {
            ...
            if (getString(R.string.key_settings_dconn_server_on_off).equals(key)) {
                ...
                checkBoxGlobalPreferences.setEnabled(checked);
