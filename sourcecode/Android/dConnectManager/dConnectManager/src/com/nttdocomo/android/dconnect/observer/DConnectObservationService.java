...
import com.nttdocomo.android.dconnect.observer.activity.WarningDialogActivity;
...
public class DConnectObservationService extends Service {
     ...
     * オブザーバー監視開始アクション.
     */
    public static final String ACTION_START = "com.nttdocomo.android.dconnect.intent.action.observer.START";
    
    /**
     * オブザーバー監視停止アクション.
     */
    public static final String ACTION_STOP = "com.nttdocomo.android.dconnect.intent.action.observer.STOP";

    /**
     * 監視アクション.
     */
    public static final String ACTION_CHECK = "com.nttdocomo.android.dconnect.intent.action.observer.CHECK";
