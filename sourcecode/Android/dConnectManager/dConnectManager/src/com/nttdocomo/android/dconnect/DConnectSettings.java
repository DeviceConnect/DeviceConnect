...
public final class DConnectSettings {
    ...
    /** 外部IPのアクセス権限. */
    private boolean mAllowGlobalIP = false;
    ...
    public void load(final Context context) {
        ...
        setAllowGlobalIP(sp.getBoolean(context.getString(R.string.key_settings_dconn_allow_global_ip), false));
        try {
     ...
     */
    public boolean alowGlobalIP() {
        return mAllowGlobalIP;
    }
     ...
     */
    public void setAllowGlobalIP(final boolean allow) {
        this.mAllowGlobalIP = allow;
    }
