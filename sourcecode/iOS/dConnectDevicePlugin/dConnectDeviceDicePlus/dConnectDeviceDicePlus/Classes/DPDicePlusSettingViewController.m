//
//  DPDicePlusSettingViewController.m
//  DConnectSDK
//
...
#import "DPDicePlusSettingViewController.h"
#import "DPDicePlusManager.h"
@interface DPDicePlusSettingViewController  () <UIPageViewControllerDataSource>{
    NSArray *_pages;
}
@end

@implementation DPDicePlusSettingViewController
...
//    NSString *settingsTitle = [bundle localizedStringForKey:@"SpheroSettingsTitle" value:@"Settings" table:@"Localizable"];
    ...
    title.text = @"DICE+";  //Localizeしなくても良さそうなので
    [title sizeToFit];
...
{
    [[DPDicePlusManager sharedManager].connectDelegateList removeAllObjects];
