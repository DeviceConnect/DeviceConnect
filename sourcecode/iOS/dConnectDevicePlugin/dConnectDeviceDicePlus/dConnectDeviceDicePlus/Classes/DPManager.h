 ...
 */
- (void)manager:(DPManager *)manager didConnectDie:(DPDie *)die;
 ...
 */
- (void)manager:(DPManager *)manager didDisconnectDie:(DPDie *)die;
 ...
 */
- (void)manager:(DPManager *)manager didFailConnecttDie:(DPDie *)die;
 ...
 */
- (void)manager:(DPManager *)manager didFinishedScan:(NSArray *)diceList;
...
/*!
 @brief Dice+管理クラス。
 */
@interface DPManager : NSObject <DPDiceManagerDelegate, DPDieDelegate>
