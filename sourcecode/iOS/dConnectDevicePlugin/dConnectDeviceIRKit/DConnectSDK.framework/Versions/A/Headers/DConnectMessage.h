...
typedef NS_ENUM(NSUInteger, DConnectMessageErrorCodeType) {
    ...
    DConnectMessageErrorCodeNotSupportAttribute,      /*!< サポートされていない属性・インターフェースが指定された. */
    ...
    DConnectMessageErrorCodeUnknownAttribute,         /*!< 未知のインターフェース・属性にアクセスされた. */
...
/*!
 ...
 戻り値は @link NSJSONSerialization::JSONObjectWithData:options:error @endlink の戻り値と
 同じになる。
