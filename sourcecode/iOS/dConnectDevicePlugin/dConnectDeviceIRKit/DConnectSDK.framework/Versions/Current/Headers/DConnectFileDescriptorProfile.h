...
/*!
 ...
 @brief File Descriptor Profile各APIリクエスト通知用デリゲート。
...
/*!
 ...
 profileがファイルオープンリクエストを受け取ったことを通知する。<br>
...
/*!
 ...
 profileがファイル読み込みリクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがファイルクローズリクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがファイル書き込みリクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがonwatchfileイベント登録リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがonwatchfileイベント解除リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
