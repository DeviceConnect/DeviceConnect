...
//  DConnectSDK
//
//  Created by 安部 将史 on 2014/07/09.
...
/*!
 ...
 profileが再生状態取得リクエストを受け取ったことを通知する。<br>
...
/*!
 ...
 profileがコンテンツ情報取得リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがコンテンツ一覧取得リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileが再生位置取得リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがメディアプレーヤーの音量取得リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがメディアプレーヤーミュート状態取得リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileが再生コンテンツ変更リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileが再生開始リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileが再生停止リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileが再生一時停止リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileが再生再開リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileが再生位置変更リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがonstatuschangeイベント登録リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがメディアプレーヤーの音量変更リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがメディアプレーヤーミュート有効化リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがメディアプレーヤーミュート無効化リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがonstatuschangeイベント解除リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 @param[in] description メディアの再生時間
