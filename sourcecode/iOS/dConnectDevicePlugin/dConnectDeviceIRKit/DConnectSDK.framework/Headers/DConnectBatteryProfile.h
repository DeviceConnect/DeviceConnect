...
/*!
 ...
 @brief Battery Profile各APIリクエスト通知用デリゲート。
...
/*!
 @brief 全属性取得リクエストを受け取ったことをデリゲートに通知する。
 
 profileが全属性取得リクエストを受け取ったことを通知する。<br>
...
/*!
 @brief level属性取得リクエストを受け取ったことをデリゲートに通知する。
 
 profileがlevel属性取得リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 @brief charging属性取得リクエストを受け取ったことをデリゲートに通知する。
 
 profileがcharging属性取得リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 @brief chargingtime属性取得リクエストを受け取ったことをデリゲートに通知する。
 
 profileがchargingtime属性取得リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 @brief dischargingtime属性取得リクエストを受け取ったことをデリゲートに通知する。
 
 profileがdischargingtime属性取得リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがonchargingchangeイベント登録リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがonbatterychangeイベント登録リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがonchargingchangeイベント解除リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 profileがonbatterychangeイベント解除リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 ...
 @param[in] charging 充電中はtrue、それ以外はfalse
