...
//  DConnectSDK
//
//  Created by 安部 将史 on 2014/06/04.
...
/*!
 ...
 @brief Device Orientation Profile各APIリクエスト通知用デリゲート。
...
/*!
 ...
 profileがondeviceorientationイベント登録リクエストを受け取ったことを通知する。<br>
...
/*!
 ...
 profileがondeviceorientationイベント解除リクエストを受け取ったことを通知する。<br>
 実装されない場合には、Not supportのエラーが返却される。
...
/*!
 @brief メッセージにx軸方向の(重力込み)加速度を設定する。
 @param[in] x x軸方向の(重力込み)加速度
 @param[in,out] message x軸方向の(重力込み)加速度を格納するメッセージ
 */
+ (void) setX:(double)x target:(DConnectMessage *)message;

/*!
 @brief メッセージにy軸方向の(重力込み)加速度を設定する。
 @param[in] y y軸方向の(重力込み)加速度
 @param[in,out] message y軸方向の(重力込み)加速度を格納するメッセージ
 */
+ (void) setY:(double)y target:(DConnectMessage *)message;

/*!
 @brief メッセージにx軸方向の(重力込み)加速度を設定する。
 @param[in] z z軸方向の(重力込み)加速度
 @param[in,out] message z軸方向の(重力込み)加速度を格納するメッセージ
 */
